...
class EquivariantNeuralField(nn.Module):
    ...
    def __init__(
        ...
        self.W_emb_q = nn.Sequential(
            SinusoidalPosEmbedding(self.num_in, self.num_hidden, self.emb_freq),
    ...
    def __call__(self, x, p, c, g):
        ...
        v_g, v_b = torch.split(self.W_emb_v(rel_pos), split_size_or_sections=2*self.latent_dim, dim=-1)
